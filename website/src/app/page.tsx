export default function Home() {
  return (
    <>
      ...
      >
        <span
          className="select-none whitespace-nowrap font-heading font-bold uppercase text-anthracite-700"
          style={{
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        {/* Hero */}
        <main className="flex flex-1 items-center justify-center bg-warm-cream/40 px-6 md:px-12">
          <section className="mx-auto max-w-xl py-20 text-center md:py-32">
            ...
            <div className="mx-auto mt-12 max-w-sm space-y-4 text-anthracite-600" style={{ lineHeight: "1.7" }}>
              ...
              <div className="pt-2">
                <p>
                  <a
                    href="mailto:office@claudiaplessl.at"
                    className="underline decoration-sage-300 underline-offset-4 transition-colors hover:text-sage-700 hover:decoration-sage-500"
                  >
                    office@claudiaplessl.at
                  </a>
                </p>
                <p className="mt-1">
                  <a
