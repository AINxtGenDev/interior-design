...
typography:
  # — reading ramp (Inter body / Jost tracked chrome) —
  ...
  label:       { fontFamily: "Jost", px: 14, weight: 500, tracking: "3px", upper: true, color: "accent" }
  attribution: { fontFamily: "Jost", px: 15, weight: 500, tracking: "2px", upper: true, color: "accent" }
  micro:       { fontFamily: "Jost", px: 12, weight: 500, tracking: "2px", upper: true, color: "accent" }
...
- **Weights** — the brand font ships `{300, 400, 500}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
The voice is a literary pairing: **Cormorant Garamond** at weight 400 (never bold, always sentence case) carries every headline, numeral, and quote mark in ink; **Inter**
